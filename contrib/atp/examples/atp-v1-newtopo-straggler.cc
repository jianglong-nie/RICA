...
main(int argc, char* argv[])
{
    ...
    s0s3Device->SetThresholdBytes(102400);
    s1s3Device->SetThresholdBytes(102400);
    s2s3Device->SetThresholdBytes(102400);
    s3ps1Device->SetThresholdBytes(102400);
    s3ps2Device->SetThresholdBytes(102400);
