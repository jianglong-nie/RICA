...
class PointToPointNetDevice : public NetDevice
{
  public:
    ...
    void SetThresholdBytes(uint32_t thresholdBytes) { m_thresholdBytes = thresholdBytes; }
    uint32_t GetThresholdBytes() const { return m_thresholdBytes; }

    void SetEnableEcn(bool enable) { enableEcn = enable; }
    bool GetEnableEcn() const { return enableEcn; }

    void SetEnableEcnBytes(bool enable) { enableEcnBytes = enable; }
    bool GetEnableEcnBytes() const { return enableEcnBytes; }
  ...
  private:
    ...
    uint32_t m_thresholdBytes = 20000 * DEFAULT_MTU;
    bool enableEcn = false;
    bool enableEcnBytes = false;
};
